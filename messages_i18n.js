...
window.uiTranslations = {
    de: {
        ...
        'btn-download-pdf': 'Als PDF',
        'btn-download-story': 'Story-Format',
    ...
    tr: {
        ...
        'btn-download-pdf': 'PDF Olarak',
        'btn-download-story': 'Hikaye Formatı',
    ...
    es: {
        ...
        'btn-download-pdf': 'Como PDF',
        'btn-download-story': 'Formato Story',
    ...
    fr: {
        ...
        'btn-download-pdf': 'En PDF',
        'btn-download-story': 'Format Story',
    ...
    bg: {
        ...
        'btn-download-pdf': 'Като PDF',
        'btn-download-story': 'Формат за История',
